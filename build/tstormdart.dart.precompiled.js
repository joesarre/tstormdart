...
PC:function(){var z,y
z=this.jO
if(this.Gx.MU-this.Lp.MU>0){y=init.globalState.i2
...
w=x&65535
if((C.jn.GG(x,16)&8191)===10)switch(w){case 438:return z.call$1(H.vR(H.d(y)+" (Error "+w+")",null))
...
n=$.ko()
m=v.qS(y)
if(m!=null)return z.call$1(H.vR(y,m))
else{m=u.qS(y)
if(m!=null){m.method="call"
return z.call$1(H.vR(y,m))}else{m=t.qS(y)
if(m==null){m=s.qS(y)
if(m==null){m=r.qS(y)
if(m==null){m=q.qS(y)
if(m==null){m=p.qS(y)
...
z.toString
P.L2(z,null,z,a,b)},function(a){return P.SZ(a,null)},null,"call$2" /* tearOffInfo */,"call$1" /* tearOffInfo */,"AY",2,2,6,7],
...
$isvs:true,
$isb8:true,
static:{"":"Gn,Ry,C3,oN,NK",Dt:function(a){return H.VM(new P.vs(0,$.X3,null,null,null,null,null,null),[a])},GZ:function(a,b){var z
b.Gv=2
z=J.x(a)
...
z.h(z,new P.LV(b,null))}},"call$1" /* tearOffInfo */,"ght",2,0,function(){return H.IG(function(a){return{func:"lU",void:true,args:[a]}},this.$receiver,"Kd")}],
xO:function(a){var z,y
z=this.Gv
...
z=this.Y8
if((z.Gv&8)!==0){y=z.iP
y.yy(y)}P.ot(z.gp4())},"call$0" /* tearOffInfo */,"gp4",0,0,4],
LP:[function(){var z=this.Y8
if((z.Gv&8)!==0)z.iP.QE()
P.ot(z.gZ9())},"call$0" /* tearOffInfo */,"gZ9",0,0,4],
$asKA:null},
nP:{
"":"a;"},
KA:{
...
T9:[function(a){return J.Dk(a)},"call$1" /* tearOffInfo */,"py",2,0,8],
...
ad:[function(a,b){return a==null?b==null:a===b},"call$2" /* tearOffInfo */,"N3",4,0,9],
xv:[function(a){return H.CU(a)},"call$1" /* tearOffInfo */,"J2",2,0,10],
...
"%":"Location"},
El:{
"":"qE;kc:error=,kr:muted%,LA:src},OK:volume}",
...
wD:{
"":"d5;mH:href=",
"%":"SVGGradientElement|SVGLinearGradientElement|SVGRadialGradientElement"}}],["dart.math","dart:math",,P,{
"":"",
...
return}throw "Unable to print message: " + String(a)}}],["game","file:///media/mass/home/joe/programming/tstormdart/web/game.dart",,Q,{
"":"",
XS:function(a,b,c){J.vP(J.qk(a),H.d(b*100)+"%")
J.OE(a.style,H.d(c*100)+"%")},
T3:{
"":"a;U8,l2,fW",
static:{"":"IV"}},
fq:{
"":"a;Vm,YK,zD,UX,aj,yQ,UL",
fR:[function(a){var z
if(J.Zm(a)===77)O.DO(J.mj(document.querySelector("#soundtrack"))!==!0)
if(a.keyCode===82)J.FQ(C.ol.gmW(window),J.CC(C.ol.gmW(window)))
z=this.Vm
z.u(z,a.keyCode,!0)},"call$1" /* tearOffInfo */,"gQ6",2,0,22],
Nd:[function(a){var z=this.Vm
z.u(z,J.Zm(a),!1)},"call$1" /* tearOffInfo */,"gjX",2,0,22],
MN:function(a){var z,y,x,w,v,u,t,s,r,q,p,o
for(z=0;y=this.aj,z<y.length;++z)y[z].MN(a)
for(y=J.Wx(a),z=0;x=this.UX,z<x.length;++z){x=x[z]
if(!x.D2){w=x.Vt.Vm
v=w.t(w,x.Mt)===!0?-1.65:0
w=x.Vt.Vm
if(w.t(w,x.dX)===!0)v=1.65
w=x.Vt.Vm
u=w.t(w,x.rh)===!0?-1.65:0
w=x.Vt.Vm
if(w.t(w,x.qA)===!0)u=1.65
w=y.W(a,x.T8)
t=x.ZB
if(typeof w!=="number")return H.s(w)
...
x.Gp=w
if(t>0.42){x.ZB=0.42
t=0.42}if(w>0.42){x.Gp=0.42
w=0.42}if(t<-0.42)x.ZB=-0.42
if(w<-0.42)x.Gp=-0.42
B.Fy.prototype.MN.call(x,a)}if(x.J7)if(J.xZ(y.W(a,x.qt),1000))x.J7=!1
else{w=x.WT
x.ZB=w.ZB
x.Gp=w.Gp
t=w.x
...
x.ZB=p+(t-s)*200*q/1000
s=x.Gp
if(typeof s!=="number")return s.g()
x.Gp=s+(w-r)*200*q/1000
o="matching killer location: "+H.d(x.x)+", "+H.d(x.y)+".  dead: "+x.D2
H.qw(o)
B.Fy.prototype.MN.call(x,a)}}},
W2:function(a){var z,y,x,w
for(z=0;y=this.UX,z<y.length;++z)y[z].W2(a)
for(z=0;y=this.aj,z<y.length;++z)y[z].W2(a)
for(z=0;y=this.UX,z<y.length;++z){y=y[z]
x=y.D2?y.ih:6
w=document.querySelector("div#player"+z+"_score>span.score")
y=this.UX
if(z>=y.length)return H.e(y,z)
w.textContent=C.jn.bu(y[z].V3)
y=w.style
if(x>=7)return H.e(C.yZ,x)
J.FI(y,"#"+C.yZ[x])}},
yM:function(a){var z,y,x,w,v,u,t,s,r
for(z=0;y=this.aj,z<y.length;++z){y=y[z]
x=y.x
w=y.y
for(v=0;y=this.UX,v<y.length;++v){y=y[v]
if(!y.D2){u=y.x
if(typeof u!=="number")return u.W()
if(typeof x!=="number")return H.s(x)
t=u-x
if(t>0.00625)continue
y=y.y
if(typeof y!=="number")return y.W()
if(typeof w!=="number")return H.s(w)
s=y-w
if(s>0.00625)continue
if(t*t+s*s<=0.00015625000000000003){y="player "+C.jn.bu(v)+" has died with score "
u=this.UX
if(v>=u.length)return H.e(u,v)
u=y+C.jn.bu(u[v].V3)+" at position ("
y=this.UX
...
z.Av=x
if(x>z.A5)z.Av=0}if(z.Av===z.A5&&y){y=this.aj
if(y.length>50)z.yw=!1
else{z=new Y.ei(0,0,H.VM([],[W.pA]),null,null,null,null,0,0,0,0,null,null,!1,0.00625)
z.ZH(this,5,null)
z.Gp=0
z.ZB=0
y.push(z)}}for(z=J.Wx(a),w=0;y=this.UX,w<y.length;++w){y=y[w]
if(!y.D2)y.V3=J.XH(z.U(a,0.03))}this.yM(a)
for(y=this.UX,x=y.length,v=!0,w=0;w<x;++w)v=v&&y[w].D2
if(v){y=this.UL
if(!y.l2){y.l2=!0
y.U8=a}}y=this.UL
if(y.l2){x=z.W(a,y.U8)
if(typeof x!=="number")return H.s(x)
if(2000>x){z=z.W(a,y.U8)
if(typeof z!=="number")return H.s(z)
u=1-1*z/2000}else u=0
J.DG(y.fW,u)}},
...
y=this.gtV()
C.ol.hr(z)
C.ol.oB(z,W.VF(y))},"call$1" /* tearOffInfo */,"gtV",2,0,5],
UM:function(){var z,y
this.YK=document.querySelector("div#game")
P.JS("initialising game")
z=H.VM(new W.RO(window,C.rl.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(this.gQ6()),z.Sg),[H.Kp(z,0)]).Zz()
z=H.VM(new W.RO(window,C.Z4.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(this.gjX()),z.Sg),[H.Kp(z,0)]).Zz()
document.querySelector("div#game")
this.UX=H.VM([],[G.nK])
this.aj=H.VM([],[Y.ei])
this.Vm=P.L5(null,null,null,J.im,J.kn)
z=this.UX
y=new G.nK(null,null,null,null,0,!1,null,!1,null,H.VM([],[W.pA]),null,null,null,null,0,0,0,0,null,null,!1,0.00625)
y.ZH(this,0,1)
z.push(y)
y=this.UX
...
y.u5=0.49875
y.RK=0.49875
y=new B.kW(!1,null,null)
y.A5=60
this.yQ=y
y.Av=0
y.yw=!0
J.hp(this.UL.fW)}}}],["gamepiece","file:///media/mass/home/joe/programming/tstormdart/web/gamepiece.dart",,B,{
"":"",
Fy:{
"":"a;",
Kl:function(a,b,c){var z=this.ZB
if(typeof c!=="number")return H.s(c)
...
s=y+u*v/1000
for(w=this.vT,w=new H.a7(w,w.length,0,null);w.G();){r=w.mD
v=this.jn
J.Om(J.qk(r),H.d((t-v)*100)+"%")
J.pR(r.style,H.d((s-v)*100)+"%")}this.xF=a
this.u5=t
this.RK=s},
...
if(z>1){this.x=0
z=0}if(typeof z!=="number")return z.C()
if(z<0)this.x=1
if(x>1){this.y=0
z=0}else z=x
if(z<0)this.y=1
...
J.Yj(z,S.Ir(this.ih,null))
this.Vt.YK.appendChild(z)
...
this.ZB=0
this.y=0
this.x=0}}}],["graphics","file:///media/mass/home/joe/programming/tstormdart/web/graphics.dart",,S,{
"":"",
Ir:function(a,b){var z=C.yZ[a]
if(b!=null){if(a>=7)return H.e(C.yZ,a)
return"images/ball-"+z+"-spr-"+H.d(b)+".png"}else{if(a>=7)return H.e(C.yZ,a)
return"images/ball-"+z+"-spr.png"}}}],["killer","file:///media/mass/home/joe/programming/tstormdart/web/killer.dart",,Y,{
"":"",
ei:{
"":"Fy;M6,C6,vT,x,y,ZB,Gp,xF,u5,RK,T8,ih,Vt,TA,jn",
p0:function(a){var z,y,x,w,v
for(z=J.x(a),y=this.vT,x=0;x<7;++x){w=W.jm(null,null,null)
J.Yj(w,S.Ir(this.ih,x))
this.Vt.YK.appendChild(w)
...
J.oH(w.style,"none")
y.push(w)}},
MN:function(a){var z,y,x,w,v,u,t,s,r,q,p
z=J.xH(a,this.T8)
if(this.ZB!==0&&this.Gp!==0)for(y=-1,x=1,w=0;v=this.Vt.UX,w<v.length;++w){v=v[w]
u=v.x
t=this.x
if(typeof u!=="number")return u.W()
if(typeof t!=="number")return H.s(t)
...
p=(t*s+q*r)/Math.sqrt((t*t+q*q)*(v+u))
if(p>y)y=p}}else{y=-1
x=1}v=6-P.y(P.J(C.CD.yu(x*100),6),0)
this.M6=v
u=this.C6
t=u+1
if(v>t){this.M6=t
...
if(v<u){this.M6=u
v=u}this.C6=v
if(y>=0.85)this.tn(5,z)
else this.tn(0.2,z)
this.Kl(($.z6().w7()-0.5)*1.4,($.z6().w7()-0.5)*1.4,z)
v=this.ZB
if(typeof v!=="number")return v.D()
if(v>0.42){this.ZB=0.42
v=0.42}u=this.Gp
if(typeof u!=="number")return u.D()
if(u>0.42){this.Gp=0.42
u=0.42}if(typeof v!=="number")return v.C()
if(v<-0.42)this.ZB=-0.42
if(typeof u!=="number")return u.C()
if(u<-0.42)this.Gp=-0.42
B.Fy.prototype.MN.call(this,a)},
W2:function(a){var z,y
for(z=this.vT,y=new H.a7(z,z.length,0,null);y.G();)J.oH(J.qk(y.mD),"none")
y=this.M6
if(y>>>0!==y||y>=z.length)return H.e(z,y)
J.oH(z[y].style,"")
B.Fy.prototype.W2.call(this,a)},
static:{"":"o1,Qr,qT,pn"}}}],["options","file:///media/mass/home/joe/programming/tstormdart/web/options.dart",,O,{
"":"",
I1:[function(a){var z,y,x,w
z=document.querySelector("#soundtrack")
y=document.querySelector("#mute")
x=J.mj(z)
w=J.S6(y)
if(x==null?w!=null:x!==w)O.DO(w)},"call$1" /* tearOffInfo */,"fO",2,0,11],
DO:function(a){var z,y,x
z=document.querySelector("#soundtrack")
J.Ae(document.querySelector("#mute"),a)
J.LM(z,a)
if(a===!0){if(J.kE(J.M6(C.ol.gmW(window)),"mute")!==!0){y=C.ol.gmW(window)
x=J.RE(y)
x.srk(y,J.WB(x.grk(y),"mute"))}}else if(J.kE(J.M6(C.ol.gmW(window)),"mute")===!0)J.nU(C.ol.gmW(window),J.md(J.M6(C.ol.gmW(window)),"mute",""))},
OG:[function(a){J.FQ(C.ol.gmW(window),J.CC(C.ol.gmW(window)))},function(){return O.OG(null)},null,"call$1" /* tearOffInfo */,"call$0" /* tearOffInfo */,"hk",0,2,12,7]}],["player","file:///media/mass/home/joe/programming/tstormdart/web/player.dart",,G,{
"":"",
nK:{
"":"Fy;Mt,rh,dX,qA,V3,D2,WT,J7,qt,vT,x,y,ZB,Gp,xF,u5,RK,T8,ih,Vt,TA,jn",
W2:function(a){var z,y,x,w
for(z=this.vT,z=new H.a7(z,z.length,0,null);z.G();){y=z.mD
if(this.D2&&this.J7){x=this.qt
if(typeof x!=="number")return H.s(x)
if(typeof a!=="number")return H.s(a)
x=0.00625*(1000+x-a)/1000
this.jn=x
w=2*x*100
J.vP(J.qk(y),H.d(w)+"%")
J.OE(y.style,H.d(w)+"%")}if(this.D2&&!this.J7)J.oH(J.qk(y),"none")
if(!this.D2||this.J7)B.Fy.prototype.W2.call(this,a)}},
static:{"":"EG,e4"}}}],["timer","file:///media/mass/home/joe/programming/tstormdart/web/timer.dart",,B,{
"":"",
kW:{
"":"a;yw,A5,Av"}}],["tstormdart","file:///media/mass/home/joe/programming/tstormdart/web/tstormdart.dart",,T,{
"":"",
E2:[function(){var z,y,x,w,v,u
z=document.querySelector("#soundtrack")
y=document.querySelector("#mute")
x=J.kE(J.M6(C.ol.gmW(window)),"mute")
J.LM(z,x)
w=J.RE(y)
w.sd4(y,x)
w=w.gVl(y)
H.VM(new W.xC(0,w.uv,w.Ph,W.VF(O.fO()),w.Sg),[H.Kp(w,0)]).Zz()
v=document.querySelector("#restart")
v.toString
w=H.VM(new W.Cq(v,C.T1.Ph,!1),[null])
H.VM(new W.xC(0,w.uv,w.Ph,W.VF(O.hk()),w.Sg),[H.Kp(w,0)]).Zz()
w=new Q.T3(null,!1,null)
w.fW=document.querySelector("audio")
u=new Q.fq(null,null,null,null,null,null,w)
u.UM()
J.oH(document.querySelector("#loading").style,"none")
w=window
x=u.gtV()
C.ol.hr(w)
C.ol.oB(w,W.VF(x))},"call$0" /* tearOffInfo */,"lS",0,0,4]},1],])
...
return J.Wx(a).F(a,b)}
J.LM=function(a,b){return J.RE(a).skr(a,b)}
...
J.mj=function(a){return J.RE(a).gkr(a)}
...
C.yZ=I.makeConstantList(["00ff00","00ffff","ff00ff","ffff00","c9c9c9","ff0000","b6b4b5"])
C.Yb=H.Kx('ue')
C.VG=H.Kx('iY')
C.vB=J.is.prototype
C.ol=W.Oi.prototype
...
I.$lazy($,"rng","o1","z6",function(){return C.pr})

init.functionAliases={}
init.metadata=[{func:"Tz",void:true,args:[null,null]},{func:"NT"},{func:"eu",args:[P.EH,null,J.im,null,null,null,null]},{func:"Gl",ret:J.kn,args:[null,null]},{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"KV",void:true,args:[null],opt:[P.mE]},,{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"bB",void:true,args:[W.Aj]},{func:"OG",void:true,opt:[W.Aj]},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"zx",args:[J.O]},{func:"BG",args:[null],opt:[null]},{func:"zk",args:[J.kn]},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"BB",void:true,args:[W.HL]},];$=null
...
El.prototype.gkr=function(receiver){return receiver.muted}
El.prototype.skr=function(receiver,v){return receiver.muted=v}
...
if($desc instanceof Array)$desc=$desc[1]
tB.prototype=$desc
tB.prototype.gmH=function(receiver){return receiver.href}
...
if($desc instanceof Array)$desc=$desc[1]
O2.prototype=$desc
function aX(jO,Gx,Lp,En){this.jO=jO
this.Gx=Gx
this.Lp=Lp
...
if($desc instanceof Array)$desc=$desc[1]
Rd.prototype=$desc
function T3(U8,l2,fW){this.U8=U8
this.l2=l2
this.fW=fW}T3.builtin$cls="T3"
if(!"name" in T3)T3.name="T3"
$desc=$collectedClasses.T3
if($desc instanceof Array)$desc=$desc[1]
T3.prototype=$desc
function fq(Vm,YK,zD,UX,aj,yQ,UL){this.Vm=Vm
this.YK=YK
this.zD=zD
this.UX=UX
this.aj=aj
this.yQ=yQ
this.UL=UL}fq.builtin$cls="fq"
...
if($desc instanceof Array)$desc=$desc[1]
Fy.prototype=$desc
function ei(M6,C6,vT,x,y,ZB,Gp,xF,u5,RK,T8,ih,Vt,TA,jn){this.M6=M6
this.C6=C6
this.vT=vT
this.x=x
this.y=y
...
this.Vt=Vt
this.TA=TA
this.jn=jn}ei.builtin$cls="ei"
if(!"name" in ei)ei.name="ei"
$desc=$collectedClasses.ei
if($desc instanceof Array)$desc=$desc[1]
ei.prototype=$desc
function nK(Mt,rh,dX,qA,V3,D2,WT,J7,qt,vT,x,y,ZB,Gp,xF,u5,RK,T8,ih,Vt,TA,jn){this.Mt=Mt
this.rh=rh
this.dX=dX
this.qA=qA
this.V3=V3
...
this.Vt=Vt
this.TA=TA
this.jn=jn}nK.builtin$cls="nK"
if(!"name" in nK)nK.name="nK"
$desc=$collectedClasses.nK
if($desc instanceof Array)$desc=$desc[1]
nK.prototype=$desc
function kW(yw,A5,Av){this.yw=yw
this.A5=A5
this.Av=Av}kW.builtin$cls="kW"
if(!"name" in kW)kW.name="kW"
$desc=$collectedClasses.kW
if($desc instanceof Array)$desc=$desc[1]
kW.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,n6,Ny,OM,QQ,fW,y4,d7,Um,oJ,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,Wq,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,pA,Mi,HL,MX,wP,eP,AL,Og,u8,YI,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,A6,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,Lx,h4,UK,GI,Tb,Iv,BT,yY,kJ,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,WS,r0,jf,yp,c1,Mq,Nf,Nc,Mx,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,JY,Pq,kx,nV,Zc,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,Ef,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,tB,N9,BA,tp,rE,zw,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,vt,rQ,fv,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,YS,ox,ZD,rD,wD,BD,r7,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,HY,F0,FK,Pu,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,fc,Bj,NO,II,fP,X1,HU,oo,OW,Tf,AP,yH,FA,Av,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,lb,tD,hJ,cu,dC,wN,VX,a7,i1,xy,MH,SU,Ca,b8,vs,da,xw,dm,rH,mi,jb,wB,Gv,qh,Sd,jv,i4,YJ,lz,Rl,Jb,M4,B5,PI,MO,Kd,UO,Bc,VT,Fj,q1,Zz,ly,MF,O9,yU,nP,KA,qB,ez,fI,LV,dp,B3,CR,Qk,v1,uR,QX,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,lD,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,EH,An,c8,a,mE,Rn,wv,BV,id,zL,ec,Fk,RO,Cq,xC,Pb,W9,rB,mg,ue,iY,C0,Rd,T3,fq,Fy,ei,nK,kW]}